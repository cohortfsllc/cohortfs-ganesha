...
sal_functions_t localsal_functions =
	...
	.state_upgrade_share = localstate_update_share;
	...
	.state_check_dir_delegation = localstate_check_dir_delegation;
	.state_create_lock_state = localstate_create_lock_state;
	.state_delete_lock_state = localstate_delete_lock_state;
	.state_query_lock_state = state_query_lock_state;
	.state_inc_lock_state = state_inc_lock_state;
