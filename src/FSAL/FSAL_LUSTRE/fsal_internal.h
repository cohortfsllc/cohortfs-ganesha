...
fsal_status_t LUSTREFSAL_lock(lustrefsal_file_t* descriptor, /* IN */
			   fsal_off_t* offset, /* IN/OUT */
			   fsal_size_t* length, /* IN/OUT */
			   fsal_locktype_t* type, /* IN/OUT */
			   fsal_lockowner_t* owner, /* IN/OUT */
			   lustrefsal_filelockinfo_t* fileinfo, /* IN/OUT */
			   fsal_boolean_t reclaim, /* IN */
			   lustrefsal_lockpromise_t* promise /* OUT */
    );

fsal_status_t LUSTREFSAL_unlock(lustrefsal_file_t* descriptor, /* IN */
...
fsal_status_t LUSTREFSAL_lockt(lustrefsal_file_t* descriptor, /* IN */
			    fsal_off_t* offset, /* IN/OUT */
			    fsal_size_t* length, /* IN/OUT */
			    fsal_locktype_t* type, /* IN/OUT */
			    fsal_lockowner_t* owner, /* IN/OUT */
