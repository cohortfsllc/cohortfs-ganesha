 ...
 *
 * This function implements the COHORT_REPLICATION_CONTROL operation.
 *
...
#define arg_COHORT_REPLICATION_CONTROL op->nfs_argop4_u.cohort_replication_control
#define res_COHORT_REPLICATION_CONTROL resp->nfs_resop4_u.cohort_replication_control

int cohort_replication_control(struct nfs_argop4 *op, compound_data_t * data,
			       struct nfs_resop4 *resp)
{
  ...
  if (arg_COHORT_REPLICATION_CONTROL.ccra_operation == COHORT_BEGIN)
	...
	memset(&nfs_clientid, 0, sizeof(nfs_clientid));
      ...
      nfs_clientid.client_name[arg_COHORT_REPLICATION_CONTROL.ccra_client_owner.co_ownerid.co_ownerid_len]
	= '\0';
	...
	= arg_COHORT_REPLICATION_CONTROL.ccra_stateid;
	   ...
	   COHORT_END)
    {
      ...
      strncpy(client_name,
	      arg_COHORT_REPLICATION_CONTROL.ccra_client_owner.co_ownerid.co_ownerid_val,
	      arg_COHORT_REPLICATION_CONTROL.ccra_client_owner.co_ownerid.co_ownerid_len);
      client_name[arg_COHORT_REPLICATION_CONTROL.ccra_client_owner.co_ownerid.co_ownerid_len]
	= '\0';
    ...
    {
      res_COHORT_REPLICATION_CONTROL.ccrr_status = NFS4ERR_INVAL;
      return res_COHORT_REPLICATION_CONTROL.ccrr_status;
    }

  res_COHORT_REPLICATION_CONTROL.ccrr_status = NFS4_OK;
  return res_COHORT_REPLICATION_CONTROL.ccrr_status;
