 ...
 */
typedef enum {
	CACHE_INODE_SUCCESS =			GNSH_U_S_SUCCESS,
	CACHE_INODE_MALLOC_ERROR =		GNSH_U_S_MALLOC_ERROR,
	CACHE_INODE_POOL_MUTEX_INIT_ERROR =	GNSH_U_S_POOL_MUTEX_INIT_ERROR,
	CACHE_INODE_GET_NEW_LRU_ENTRY =		GNSH_U_S_GET_NEW_LRU_ENTRY,
	CACHE_INODE_INIT_ENTRY_FAILED =		GNSH_U_S_INIT_ENTRY_FAILED,
	CACHE_INODE_FSAL_ERROR =		GNSH_U_S_FSAL_ERROR,
	CACHE_INODE_LRU_ERROR =			GNSH_U_S_LRU_ERROR,
	CACHE_INODE_HASH_SET_ERROR =		GNSH_U_S_HASH_SET_ERROR,
	CACHE_INODE_NOT_A_DIRECTORY =		GNSH_U_S_NOT_A_DIRECTORY,
	CACHE_INODE_INCONSISTENT_ENTRY =	GNSH_U_S_INCONSISTENT_ENTRY,
	CACHE_INODE_BAD_TYPE =			GNSH_U_S_BAD_TYPE,
	CACHE_INODE_ENTRY_EXISTS =		GNSH_U_S_ENTRY_EXISTS,
	CACHE_INODE_DIR_NOT_EMPTY =		GNSH_U_S_DIR_NOT_EMPTY,
	CACHE_INODE_NOT_FOUND =			GNSH_U_S_NOT_FOUND,
	CACHE_INODE_INVALID_ARGUMENT =		GNSH_U_S_INVALID_ARGUMENT,
	CACHE_INODE_INSERT_ERROR =		GNSH_U_S_INSERT_ERROR,
	CACHE_INODE_HASH_TABLE_ERROR =		GNSH_U_S_HASH_TABLE_ERROR,
	CACHE_INODE_FSAL_EACCESS =		GNSH_U_S_FSAL_EACCESS,
	CACHE_INODE_IS_A_DIRECTORY =		GNSH_U_S_IS_A_DIRECTORY,
	CACHE_INODE_FSAL_EPERM =		GNSH_U_S_FSAL_EPERM,
	CACHE_INODE_NO_SPACE_LEFT =		GNSH_U_S_NO_SPACE_LEFT,
	CACHE_INODE_READ_ONLY_FS =		GNSH_U_S_READ_ONLY_FS,
	CACHE_INODE_IO_ERROR =			GNSH_U_S_IO_ERROR,
	CACHE_INODE_FSAL_ESTALE =		GNSH_U_S_FSAL_ESTALE,
	CACHE_INODE_FSAL_ERR_SEC =		GNSH_U_S_FSAL_ERR_SEC,
	CACHE_INODE_STATE_CONFLICT =		GNSH_U_S_STATE_CONFLICT,
	CACHE_INODE_QUOTA_EXCEEDED =		GNSH_U_S_QUOTA_EXCEEDED,
	CACHE_INODE_DEAD_ENTRY =		GNSH_U_S_DEAD_ENTRY,
	CACHE_INODE_ASYNC_POST_ERROR =		GNSH_U_S_ASYNC_POST_ERROR,
	CACHE_INODE_NOT_SUPPORTED =		GNSH_U_S_NOT_SUPPORTED,
	CACHE_INODE_STATE_ERROR =		GNSH_U_S_STATE_ERROR,
	CACHE_INODE_DELAY =			GNSH_U_S_FSAL_DELAY,
	CACHE_INODE_NAME_TOO_LONG =		GNSH_U_S_NAME_TOO_LONG,
	CACHE_INODE_BAD_COOKIE =		GNSH_U_S_BAD_COOKIE,
	CACHE_INODE_FILE_BIG =			GNSH_U_S_FILE_BIG,
	CACHE_INODE_KILLED =			GNSH_U_S_KILLED,
	CACHE_INODE_FILE_OPEN =			GNSH_U_S_FILE_OPEN,
	CACHE_INODE_FSAL_XDEV =			GNSH_U_S_FSAL_XDEV,
	CACHE_INODE_FSAL_MLINK =		GNSH_U_S_FSAL_MLINK,
	CACHE_INODE_SERVERFAULT =		GNSH_U_S_SERVERFAULT,
	CACHE_INODE_TOOSMALL =			GNSH_U_S_TOOSMALL,
	CACHE_INODE_FSAL_SHARE_DENIED =		GNSH_U_S_FSAL_SHARE_DENIED,
	CACHE_INODE_BADNAME =			GNSH_U_S_BADNAME,
	CACHE_INODE_UNION_NOTSUPP =		GNSH_U_S_UNION_NOTSUPP,
	CACHE_INODE_CROSS_JUNCTION =		GNSH_U_S_CROSS_JUNCTION,
	CACHE_INODE_IN_GRACE =			GNSH_U_S_IN_GRACE,
	CACHE_INODE_BADHANDLE =			GNSH_U_S_BADHANDLE,
