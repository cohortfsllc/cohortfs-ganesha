...
int cohort_replication_control(struct nfs_argop4 *op,    /* [IN] NFS4 OP arguments */
			       compound_data_t * data,   /* [IN] current data for the compound request */
			       struct nfs_resop4 *resp); /* [OUT] NFS4 OP results */
int nfs41_op_rintegrity(struct nfs_argop4 *op,    /* [IN] NFS4 OP arguments */
			compound_data_t * data,   /* [IN] current data for the compound request */
			struct nfs_resop4 *resp); /* [OUT] NFS4 OP results */
...
static const fattr4_dent_t __attribute__ ((__unused__)) fattr4tab[] =
{
  ...
  ,
  {
  "FATTR4_DIR_NOTIF_DELAY", 56, 0, sizeof(fattr4_dir_notif_delay), FATTR4_ATTR_READ}
  ,
  {
  "FATTR4_DIRENT_NOTIF_DELAY", 57, 0, sizeof(fattr4_dirent_notif_delay), FATTR4_ATTR_READ}
  ,
  {
