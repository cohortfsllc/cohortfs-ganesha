...
#define fsal_filelockinfo_t hpssfsal_filelockinfo_t
#define fsal_lockpromise_t hpssfsal_lockpromise_t
...
typedef void* hpssfsal_filelockinfo_t;
typedef void* hpssfsal_lockpromise_t;
